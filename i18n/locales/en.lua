...
local LocaleEn = {
  ...
  debug_menu = {
    ...
    action = {
      ...
      match_card_zone = "Match: All Cards Offline Test",
  ...
  abilities = {
    ...
    validate = {
      ...
      ice_field_out_of_board = "Ice field must fit fully inside the board.",
      bind_need_enemy_stone = "Select an enemy stone to bind.",
      blink_need_own_stone = "Select your stone to blink first.",
      blink_source_missing = "Cannot find blink source stone.",
      blink_out_of_range = "Destination is out of blink range.",
      blink_invalid_destination = "Cannot blink to that destination.",
      swap_need_own_stone = "Select your stone to swap first.",
      swap_source_missing = "Cannot find selected source stone.",
      swap_need_enemy_stone = "Select an enemy stone to swap.",
      blackhole_out_of_board = "Blackhole must fit fully inside the board.",
      explosive_cannot_place = "Cannot place explosive at that position."
    },
    hint = {
      reinforcement_click = "Click on board to place reinforcement stone",
      rockfall_click = "Click on board to place rockfall obstacle",
      ice_field_click = "Click on board to place ice field",
      bind_click = "Click an enemy stone to bind",
      blackhole_click = "Click blackhole center position",
      explosive_click = "Click explosive placement position",
      blink_step1_click = "Click your stone to blink",
      blink_step2_click = "Click destination point",
      swap_step1_click = "Click your stone to swap",
      swap_step2_click = "Click enemy stone to swap",
      generic_click = "Select target on board",
      ...
      ice_field_start = "Select ice field target: click on board. ESC/right-click to cancel",
      bind_start = "Select bind target: click enemy stone. ESC/right-click to cancel",
      blackhole_start = "Select blackhole center on board. ESC/right-click to cancel",
      explosive_start = "Select explosive placement on board. ESC/right-click to cancel",
      blink_step1_start = "Blink step 1: select your stone. ESC/right-click to cancel",
      blink_step2_start = "Blink step 2: select destination. ESC/right-click to cancel",
      swap_step1_start = "Swap step 1: select your stone. ESC/right-click to cancel",
      swap_step2_start = "Swap step 2: select enemy stone. ESC/right-click to cancel",
      generic_start = "Selecting card target... ESC/right-click to cancel",
      ...
      ice_field_out_of_board = "Click inside board to place ice field.",
      blackhole_out_of_board = "Click inside board to place blackhole center.",
      explosive_out_of_board = "Click inside board to place explosive.",
      blink_step2_out_of_board = "Click inside board to select blink destination.",
      generic_out_of_board = "Select target inside board.",
      reinforcement_sending = "Sending reinforcement card request...",
      rockfall_sending = "Sending rockfall card request...",
      ice_field_sending = "Sending ice field card request...",
      bind_sending = "Sending bind card request...",
      blackhole_sending = "Sending blackhole card request...",
      explosive_sending = "Sending explosive card request...",
      blink_sending = "Sending blink card request...",
      swap_sending = "Sending swap card request...",
      generic_sending = "Sending card request..."
    }
  },
  match = {
    title = "Match Phase",
    ...
    status = {
      ...
      card_use_sealed = "You cannot use cards while sealed.",
      card_use_locked = "You cannot use cards in the current state.",
    ...
    result = {
      ...
      reason_quick_finish_timeout = "Quick Finish deadline exceeded",
      vote_none = "None",
    ...
    info = {
      ...
      state_power_move = "Next shot boosted x{multiplier}",
      state_reversal_lock = "Reversal lock {remain} turns",
      state_quick_finish = "Quick Finish {remain} turns left",
  ...
  single_dummy = {
    title = "Single Dummy (Ability Test)",
    subtitle = "Use left panel to test abilities | Click board for targeting | N: Next Turn | R: Reset",
    ability_panel_title = "Ability Test Panel",
    next_turn_button = "Next Turn",
    turn_line = "Turn {turnIndex} | Active P{activePlayer} | Shot {shotUsed}/{shotBudget}",
    pending_line = "Targeting: {cardLabel}",
    back_button = "Back",
    status = {
      entered = "Dummy mode entered: click abilities on the left panel.",
      exited = "Single dummy test ended",
      drag_too_short = "Drag distance is too short.",
      reset_done = "Dummy state has been reset.",
      pending_target = "Select target for {cardLabel}.",
      target_cancel = "Targeting cancelled.",
      ability_applied = "Ability applied: {cardLabel}",
      ability_failed = "Ability apply failed: {code}",
      ability_sealed = "Cannot use ability while sealed.",
      turn_advanced = "Turn advanced: {turnIndex} (active P{activePlayer})"
    }
  }
}
