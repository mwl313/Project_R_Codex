...
local LocaleKo = {
  ...
  debug_menu = {
    ...
    action = {
      ...
      match_card_zone = "매치: 전체 카드 오프라인 테스트",
  ...
  abilities = {
    ...
    validate = {
      ...
      ice_field_out_of_board = "빙판은 보드 안에 완전히 들어오도록 배치해야 합니다.",
      bind_need_enemy_stone = "속박할 상대 알을 선택하세요.",
      blink_need_own_stone = "점멸시킬 내 알을 먼저 선택하세요.",
      blink_source_missing = "점멸 대상 알을 찾을 수 없습니다.",
      blink_out_of_range = "점멸 가능 거리 밖입니다.",
      blink_invalid_destination = "해당 위치로는 점멸할 수 없습니다.",
      swap_need_own_stone = "교체할 내 알을 먼저 선택하세요.",
      swap_source_missing = "교체 시작 알을 찾을 수 없습니다.",
      swap_need_enemy_stone = "교체할 상대 알을 선택하세요.",
      blackhole_out_of_board = "블랙홀은 보드 안에 완전히 들어오도록 배치해야 합니다.",
      explosive_cannot_place = "폭발물을 해당 위치에 배치할 수 없습니다."
    },
    hint = {
      reinforcement_click = "신병 위치를 보드에서 클릭",
      rockfall_click = "낙석 위치를 보드에서 클릭",
      ice_field_click = "빙판 위치를 보드에서 클릭",
      bind_click = "속박할 상대 알을 클릭",
      blackhole_click = "블랙홀 중심 위치를 클릭",
      explosive_click = "폭발물 설치 위치를 클릭",
      blink_step1_click = "점멸할 내 알을 클릭",
      blink_step2_click = "이동할 위치를 클릭",
      swap_step1_click = "교체할 내 알을 클릭",
      swap_step2_click = "교체할 상대 알을 클릭",
      generic_click = "대상을 보드에서 선택하세요.",
      reinforcement_start = "신병 대상 선택: 보드 위를 클릭해 알을 배치하세요. ESC/우클릭 취소",
      rockfall_start = "낙석 대상 선택: 보드 위를 클릭해 장애물을 배치하세요. ESC/우클릭 취소",
      ice_field_start = "빙판 대상 선택: 보드 위를 클릭해 영역을 생성하세요. ESC/우클릭 취소",
      bind_start = "속박 대상 선택: 상대 알을 클릭하세요. ESC/우클릭 취소",
      blackhole_start = "블랙홀 대상 선택: 보드 위를 클릭해 중심을 지정하세요. ESC/우클릭 취소",
      explosive_start = "폭발물 대상 선택: 보드 위를 클릭해 설치하세요. ESC/우클릭 취소",
      blink_step1_start = "점멸 1단계: 내 알을 선택하세요. ESC/우클릭 취소",
      blink_step2_start = "점멸 2단계: 이동할 위치를 선택하세요. ESC/우클릭 취소",
      swap_step1_start = "교체 1단계: 내 알을 선택하세요. ESC/우클릭 취소",
      swap_step2_start = "교체 2단계: 상대 알을 선택하세요. ESC/우클릭 취소",
      generic_start = "카드 대상 선택 중... ESC/우클릭 취소",
      reinforcement_out_of_board = "보드 안을 클릭해 신병 위치를 선택하세요.",
      rockfall_out_of_board = "보드 안을 클릭해 낙석 위치를 선택하세요.",
      ice_field_out_of_board = "보드 안을 클릭해 빙판 위치를 선택하세요.",
      blackhole_out_of_board = "보드 안을 클릭해 블랙홀 중심을 선택하세요.",
      explosive_out_of_board = "보드 안을 클릭해 폭발물 위치를 선택하세요.",
      blink_step2_out_of_board = "보드 안을 클릭해 점멸 위치를 선택하세요.",
      generic_out_of_board = "보드 안에서 대상을 선택하세요.",
      reinforcement_sending = "신병 카드 사용 요청 전송...",
      rockfall_sending = "낙석 카드 사용 요청 전송...",
      ice_field_sending = "빙판 카드 사용 요청 전송...",
      bind_sending = "속박 카드 사용 요청 전송...",
      blackhole_sending = "블랙홀 카드 사용 요청 전송...",
      explosive_sending = "폭발물 카드 사용 요청 전송...",
      blink_sending = "점멸 카드 사용 요청 전송...",
      swap_sending = "교체 카드 사용 요청 전송...",
      generic_sending = "카드 사용 요청 전송..."
    }
  },
  match = {
    title = "Match Phase",
    ...
    status = {
      ...
      card_use_sealed = "봉인 상태에서는 카드를 사용할 수 없습니다.",
      card_use_locked = "현재 상태에서는 카드를 사용할 수 없습니다.",
    ...
    result = {
      ...
      reason_quick_finish_timeout = "속전속결 제한 턴 초과",
      vote_none = "없음",
      vote_rematch = "재대결",
      vote_lobby = "메뉴"
    },
    info = {
      ...
      state_power_move = "다음 샷 강화 x{multiplier}",
      state_reversal_lock = "역전 잠금 {remain}턴",
      state_quick_finish = "속전속결 {remain}턴 남음",
  ...
  single_dummy = {
    ...
    subtitle = "좌측 패널 버튼으로 초능력 테스트 | 보드 클릭: 대상 지정 | N: 다음 턴 | R: 리셋",
    ability_panel_title = "초능력 테스트 패널",
    next_turn_button = "다음 턴 진행",
    turn_line = "턴 {turnIndex} | 활성 플레이어 P{activePlayer} | 샷 {shotUsed}/{shotBudget}",
    pending_line = "대상 선택 중: {cardLabel}",
    back_button = "뒤로",
    status = {
      entered = "더미 모드 진입: 좌측 패널에서 초능력을 클릭해 테스트하세요.",
      exited = "싱글 더미 테스트 종료",
      drag_too_short = "드래그 거리가 너무 짧습니다.",
      reset_done = "더미 상태를 초기화했습니다.",
      pending_target = "초능력 대상 선택: {cardLabel}",
      target_cancel = "대상 선택을 취소했습니다.",
      ability_applied = "초능력 적용: {cardLabel}",
      ability_failed = "초능력 적용 실패: {code}",
      ability_sealed = "봉인 상태로 초능력을 사용할 수 없습니다.",
      turn_advanced = "턴 진행: {turnIndex} (활성 플레이어 P{activePlayer})"
    }
  }
}
