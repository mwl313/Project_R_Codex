...
Constants = {
  ...
  CUTSCENE_DEFAULT_DURATION_MS = 2200,
  CUTSCENE_CARD_FOCUS_SEC = 0.68,
  CUTSCENE_BAND_ENTER_SEC = 0.34,
  CUTSCENE_CHARACTER_ENTER_SEC = 0.22,
  CUTSCENE_CHARACTER_SHAKE_SEC = 0.18,
  CUTSCENE_CHARACTER_EXIT_SEC = 0.24,
  CUTSCENE_BAND_EXIT_SEC = 0.28,
  CUTSCENE_DIM_ALPHA = 0.34,
  CUTSCENE_BAND_WIDTH = 1020,
